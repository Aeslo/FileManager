...
class ColBERTEngine(BaseEngine):
    ...
    Parameters
    ---
    model_name : HuggingFace model id. Defaults to the official ColBERTv2 checkpoint
    max_length : Max token length per document (default 180, same as ColBERT paper)
    batch_size : Number of documents encoded per forward pass (default 32)
    """
