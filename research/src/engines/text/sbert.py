...
class SBERTEngine(BaseEngine):
    ...
    Parameters
    ---
    model_name : Any model from https://www.sbert.net/docs/sentence_transformer/pretrained_models.html Defaults to all-MiniLM-L6-v2 (fast, 384-dim)
    batch_size : Batch size for encode() calls (default 64)
    """
